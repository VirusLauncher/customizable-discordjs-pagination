...
module.exports = class PaginationBuilder {
    ...
    send() {
        ...
        if (version < '14.0.0') V13Pagination(this.command, this.pages, this.buttons, this.paginationCollector, this.selectMenu);
        else if (version >= '14.0.0') V14Pagination(this.command, this.pages, this.buttons, this.paginationCollector, this.selectMenu);
