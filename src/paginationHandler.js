...
const validateData = (data) => {
    ...
    const {command, pages, paginationCollector, component: { selectMenu, buttons }} = data;
    ...
    if (!paginationCollector) throw new Error('Pagination collector configuration is required');
